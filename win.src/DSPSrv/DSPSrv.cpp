...
//-----------------------------------------------------------------------------
//- DSPSrv.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <initguid.h>
...
//-----------------------------------------------------------------------------
class CDSPSrvModule : public CAtlDllModuleT<CDSPSrvModule> {

public :
	DECLARE_LIBID(LIBID_IMDSPSrvLib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_DSPSRV, "{1596183F-3EE9-47E0-A70A-09D468571A85}")
} ;

CDSPSrvModule _AtlModule ;
