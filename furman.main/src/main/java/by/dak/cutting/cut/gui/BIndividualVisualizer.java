 ...
 * @author Peca
 */
public class BIndividualVisualizer extends IndividualVisualizer
{
    private JFrame frame;
    private Strips strips;
    private Strips cuttedStrips = null;
    private BIndividual individual;
    ...
    public BIndividualVisualizer(BIndividual individual, Strips strips, Element[] elements, float forceMinimumRatio, boolean forceBestFit)
    {
    ...
    {
        this.individual = (BIndividual) individual;
        this.update();
    }
