 ...
 */
public class VProfileJoin extends AbstractAttributedFigure implements MillingLength, ShapeProvider
{
    public static final float size = 2f;  // размер линий
    private Rectangle2D.Double rec;
    private double profileWidth;
    private java.util.List<Figure> lines;
    private java.util.List<Figure> linesButt;

    public VProfileJoin(double profileWidth)
    {
    ...
    public java.util.List<Figure> getLines()
    {
        return lines;
    }
